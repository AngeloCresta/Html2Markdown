...
public class GeneratedRegexAttribute : Attribute
{
    ...
    public GeneratedRegexAttribute(string pattern, RegexOptions options) : this(pattern, options, Timeout.Infinite)
    {
    }
    ...
    /// </remarks>
    public GeneratedRegexAttribute(string pattern, RegexOptions options, string cultureName) : this(pattern, options, Timeout.Infinite, cultureName)
    {
    }
    ...
    public GeneratedRegexAttribute(string pattern, RegexOptions options, int matchTimeoutMilliseconds) : this(pattern, options, matchTimeoutMilliseconds, string.Empty /* Empty string means Invariant culture */)
    {
    }
